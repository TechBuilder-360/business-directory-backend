...
//)
//
//types MemberPassword struct {
//	MemberID string `bson:"member_id"`
//	Password string `bson:"password"`
//}
//
//types Organisation1 struct {
...
//}
//
//types TokenTransaction struct {
//	OrgID         string    `json:"org_id" bson:"org_id"`
//	Currency      string    `json:"currency" bson:"currency"`
//	Token         float64   `json:"token" bson:"token"`
//	Type          string    `json:"types" bson:"types"`
...
//}
//types SendInviteResponse struct {
//	InvalidEmails []interface{}
//	InviteIDs     []interface{}
//}
//
//types OrgPluginBody struct {
//	PluginID string `json:"plugin_id"`
//	UserID   string `json:"user_id"`
//}
//
//types InstalledPlugin struct {
...
//}
//
//types SendInviteBody struct {
//	Emails []string `json:"emails" bson:"emails"`
//}
//
//types OrganisationAdmin struct {
...
//}
//
//types ChannelPrefixes struct {
//	Title       string `json:"title" bson:"title"`
//	Description string `json:"description" bson:"description"`
//}
//
//types CustomEmoji struct {
//	Name      string    `json:"name" bson:"name"`
...
//}
//
//types OrganisationPreference struct {
...
//}
//
//types OrgAuthentication struct {
...
//}
//
//types NotificationSchedule struct {
//	Day  string `json:"day" bson:"day"`
//	From string `json:"from" bson:"from"`
//	To   string `json:"to" bson:"to"`
//}
//
//types Sidebar struct {
...
//}
//
//types InlineMediaAndLinks struct {
...
//}
//
//types LanguagesAndRegions struct {
//	Language                      string   `json:"language" bson:"language"`
//	TimeZone                      string   `json:"time_zone" bson:"time_zone"`
...
//}
//
//types DirectMessageAnnouncement struct {
...
//}
//types OrganisationHandler struct {
//	configs     *utils.Configurations
//	mailService service.MailService
//}
//
//types updateParam struct {
//	orgFilterKey   string
...
//}
//
//types EnterLeaveMessage struct {
//	OrganisationID string `json:"organisation_id" bson:"organisation_id"`
//	MemberID       string `json:"member_id" bson:"member_id"`
//}
//
//types MemberIDS struct {
//	IDList []string `json:"id_list" bson:"id_list" validate:"required"`
//}
//
//types HandleMemberSearchResponse struct {
//	Memberinfo Member
//	Err        error
//}
