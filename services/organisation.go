...
type OrganisationService interface {
	CreateOrganisation(body *types.CreateOrgReq, user *model.UserProfile, logger *log.Entry) (*types.Organisation, error)
}
...
func (d *DefaultOrganisationService) CreateOrganisation(body *types.CreateOrgReq, user *model.UserProfile, log *log.Entry) (*types.Organisation, error) {
